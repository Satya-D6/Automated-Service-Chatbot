...
// Send admin response back to ServiceNow ticket
export async function sendResponse(sysId, { responseText, newState, adminName }) {
  const stateMap = {
    'approve': '6',
    'reject': '7',
    'hold': '3',
  ...
  const body = {
    ...
    comments: `📋 Admin Response from ${adminName}:\n\n${responseText}\n\n— Sent via UniAssist Admin Portal`,
    work_notes: `Admin ${adminName} responded: ${newState.toUpperCase()} — ${responseText}`,
  }
